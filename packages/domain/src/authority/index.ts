/**
 * @file Sovereign Authority Domain Package Exports
 */
...
// WO-002B S1-10 — compiled from config/roles/matrix.yaml. Do not edit the generated file.
export * from "./role-matrix.generated.js";
