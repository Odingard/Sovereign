...
import { EpistemicStatus, LifecycleState, AuthorityClass, AUTHORITATIVE_OBJECT_TYPES } from '../packages/domain/src/index.ts';
...
describe('Sovereign Architecture & Doctrine Tests', () => {
  ...
  it('executes deterministic Fake AI provider without cloud credentials', async () => {
    ...
    expect(candidate.disclaimer).toBe('AI candidate carries no clinical authority; requires validation.');
  });
